...
const Busqueda = () => {
    ...
    const {buscador, handleBuscador, tareas } = useTareas()

    const tareasFiltradas = busqueda === '' ? [] : tareas.filter(tarea => tarea.titulo.toLowerCase().includes(busqueda.toLowerCase()))
